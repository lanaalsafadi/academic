...
Route::get('/admin/account/editprofile', [AdminController::class, 'editProfile'])->name('admin.account.editprofile');
Route::post('/admin/account/updateprofile', [AdminController::class, 'updateProfile'])->name('admin.account.updateprofile');
Route::post('/admin/account/changepassword', [AdminController::class, 'changePassword'])->name('admin.account.changepassword');
    //reports
Route::get('admin/reports/students', [ReportController::class, 'generateStudentReport'])->name('admin.reports.students');
Route::get('admin/reports/scholarships', [ReportController::class, 'generateScholarshipReport'])->name('admin.reports.scholarships');
Route::get('admin/reports/paidprograms', [ReportController::class, 'generatePaidProgramReport'])->name('admin.reports.paidprograms');
Route::get('admin/reports/supports', [ReportController::class, 'generateSupportReport'])->name('admin.reports.supports');
//
Route::get('/admin/students/index', [StudentController::class, 'index'])->name('admin.students.index');
Route::delete('admin/students/{id}', [StudentController::class, 'destroy'])->name('admin.student.destroy');
Route::get('/admin/students/Block', [StudentController::class, 'Block'])->name('admin.students.Block');
